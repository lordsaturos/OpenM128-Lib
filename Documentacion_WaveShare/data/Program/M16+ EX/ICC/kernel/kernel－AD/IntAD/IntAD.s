...
; 		                                                        
; Ä¿    µÄ:   ½¨Á¢Ê¹ÓÃÄÚ²¿ADµÄÖĞ¶ÏÊ¾Àı³ÌĞò
; 	
; Ä¿±êÏµÍ³:   »ùÓÚAVRµ¥Æ¬»ú
; 		                                                                
; Ó¦ÓÃÈí¼ş:   ICCAVR
...
; ----------------------------------------------------------------------
; ÊµÑéÄÚÈİ£º
; Ê¹ÓÃÖĞ¶Ï¼ì²âAD0¿Ú£¬Ê¹ÓÃPB/PD¿ÚµÄLEDÖ¸Ê¾AD¶Áµ½µÄÊı¾İ¡£
; ----------------------------------------------------------------------
; Ó²¼şÁ¬½Ó£º
...
; {
; 	AdcVal = ADC&0x3FF;
; 	ADMUX = (1<<REFS0)|(AdcMux&0x0F);	//Ê¹ÓÃ AVcc ×÷ÎªADC²Î¿¼µçÔ´
...
; 	while(1)
; 	{  		 
; 		H_VAL_DISP_PORT = (AdcVal&0x300)>>8;	//ADCµÄ¸ß2Î»Val
; 		L_VAL_DISP_PORT = AdcVal&0xFF;			//ADCµÄµÍ8Î»Val
; 	}
; }
; }
; }
...
_ADEnStatus::
	...
	.byte 239,223
	.byte 191,127
	.dbfile E:\Î¢Ñ©µç×ÓCD1\²úÆ·×ÊÁÏ\¿ª·¢°åÊµÑé°å\SMKÏµÁĞ\SMK1632\ÊµÑé½Ì³Ì\ÄÚºË¼°Ö÷°åÏà¹ØÊµÑé\ÄÚºË£­AD\IntAD\IntAD.C

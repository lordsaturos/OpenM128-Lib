...
; ----------------------------------------------------------------------
; й╣яИдзхщё╨
; п╢хКр╩п╘╡БйтйЩ╬щ╫ЬEEPROMё╛ты╤аЁЖё╛й╧сцPB©з╣дLEDвЖж╦й╬ё╛╧ш╡Бйг╥ЯсКп╢хКр╩жб║ё
; ----------------------------------------------------------------------
; с╡╪Ча╛╫сё╨	
...
; 	DISP_DDR=0xFF;
; 	EEPROMwrite(0x01,wrDat);		//п╢хК╣╔╦ЖйЩ╬щ
; 	DISP_PORT=EEPROMread(0x01);		//╤аЁЖсцж╦й╬╣фяИж╓йг╥ЯуЩх╥
; 	delay50ms(40);				//сп2S╣д╧ш╡Лй╠╪Д
; 	EEPROMWriteBytes(1,wrDat_,8);	//п╢хКйЩвИ						  
; 	EEPROMReadBytes(1,rdDat_,8);	
; 	for(i=0;i<7;i++)
; 	{
; 		delay50ms(40);			//сп2S╣д╧ш╡Лй╠╪Д
; 		DISP_PORT=rdDat_[i];		//╤аЁЖсцж╦й╬╣фяИж╓йг╥ЯуЩх╥
; 	} 			
; 	while(1);
; }
; }
...
L122:
	...
	.area text(rom, con, rel)
	.dbfile D:\ICC_H\Hardware.H
	.dbfile E:\н╒я╘╣ГвсCD1\╡Зф╥вйао\©╙╥╒╟Ей╣яИ╟Е\SMKо╣ап\SMK1632\й╣яИ╫лЁл\дз╨к╪╟жВ╟ЕоЮ╧ьй╣яИ\дз╨кё╜EEPROM\EEPROM\EEPROM.C

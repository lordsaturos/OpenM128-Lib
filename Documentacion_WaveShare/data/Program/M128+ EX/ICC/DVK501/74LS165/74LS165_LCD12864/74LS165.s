...
; ----------------------------------------------------------------------
; ÊµÑéÄÚÈÝ£º
; Ê¹ÓÃDVK501ÉÏµÄLCD12864¹Û²ì´Ó74HC165ÉÏ×ª»»³öµÄÊý¾Ý¡£
; ----------------------------------------------------------------------
; Ó²¼þÁ¬½Ó£º
;               DVK501 				 M128 EX+
; 				P0		---------     PA0
...
; 
; #define IN_RXD		cbi(DDRE,0)	   //PC0 Êý¾Ý¿Ú
; #define GET_RXD		gbi(PINE,0)
; 
; #define OUT_TXD  	sbi(DDRE,1)	   //PC1 Âö³å¿Ú
; #define SET_TXD 	sbi(PORTE,1)
; #define CLR_TXD  	cbi(PORTE,1)
; 
; #define OUT_PL		sbi(DDRD,1)	   //PC2 Ëø´æ¿Ú
...
L179:
	...
	ret
	.dbend
	.dbfile E:\ÎâÔó±¸·Ý\DVK501¹âÅÌÄÚÈÝ\M128_E~1\74LS16~2\74LS165_LCD12864\74LS165.c
...
L189:
	.blkb 17
	.area idata
	.byte 178,162,215,170,180,174,32,32,210,186,190,167,207,212,202,190
	.byte 0
	.area data(ram, con, rel)
	.dbfile D:\ICC_H\Software.H
L188:
	.blkb 17
	.area idata
	.byte 55,52,'L,'S,49,54,53,45,'L,'C,'D,49,50,56,54,52
	.byte 0
	.area data(ram, con, rel)
	.dbfile D:\ICC_H\Software.H

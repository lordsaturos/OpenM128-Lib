...
; ----------------------------------------------------------------------
; ÊµÑéÄÚÈÝ£º
; Ê¹ÓÃDVK501ÉÏµÄLCD12864¹Û²ì´Ó74HC164×ª»»³öÀ´µÄÊý¾Ý,¿ÉÓëLED×ö¶Ô±È¡£															  
; ----------------------------------------------------------------------
; Ó²¼þÁ¬½Ó£º 
;           	  DVK501     			DVK501
; 				Q0		---------     L0
...
; 
; #define OUT_RXD		sbi(DDRB,6)	   //PC0 Êý¾Ý¿Ú
; #define SET_RXD		sbi(PORTB,6)
; #define CLR_RXD		cbi(PORTB,6)
; 
; #define OUT_TXD  	sbi(DDRB,7)	   //PC1 Âö³å¿Ú
...
L179:
	...
	ret
	.dbend
	.dbfile E:\ÎâÔó±¸·Ý\DVK501¹âÅÌÄÚÈÝ\M128_E~1\74LS16~1\74LS164_LCD12864\74LS164.c
...
L190:
	.blkb 14
	.area idata
	.byte 32,32,32,32,32,40,202,174,189,248,214,198,41,0
	.area data(ram, con, rel)
	.dbfile D:\ICC_H\Software.H
L189:
	.blkb 17
	.area idata
	.byte 180,174,215,170,178,162,32,32,210,186,190,167,207,212,202,190
	.byte 0
	.area data(ram, con, rel)
	.dbfile D:\ICC_H\Software.H
L188:
	.blkb 17
	.area idata
	.byte 55,52,'L,'S,49,54,52,45,'L,'C,'D,49,50,56,54,52
	.byte 0
	.area data(ram, con, rel)
	.dbfile D:\ICC_H\Software.H
